    ...
    try:
        ...
        if IP in singlepacket:
            ...
            if TCP in singlepacket:
                ...
                save(
                    "alert tcp {0} {1}-> $HOME_NET any (msg: \"Suspicious IP {0} and port {1} detected!\"; reference:arachnids; classtype:trojan-activity; sid:{2}; rev:1;)".format(
                        tcpsourceport, tcpdestport,sid_gen()))
                save(
                    "alert tcp $HOME_NET any -> {0} {1} (msg: \"Suspicious IP {0} and port {1} detected!\"; reference:arachnids; classtype:trojan-activity; sid:{2}; rev:1;)".format(
                        ipdest, tcpdestport,sid_gen()))
                ...
                if DNS in singlepacket:
                    ...
                    if DNSRR in singlepacket:
                        ...
                        print("\b|\"; distance:4; reference:arachnids; classtype:trojan-activity; sid:sdss; rev:1;)")
                    else:
                        save(
                        ...
                        print(
                            "\b\"; fast_pattern; nocase; distance:0; reference:arachnids; classtype:trojan-activity; sid:ssss; rev:1;)")
                # Check if a HTTP request is present in the packet
                    ...
                    print(
                        "Host:\nalert tcp $HOME_NET any -> any $HTTP_PORTS (msg: \"Suspicious HTTP {0[Method]} request to {0[Host]} detected!\"; flow:established,to_server; content:\"Host|3a 20|{0[Host]}|0d 0a|\"; http_header; reference:arachnids; classtype:trojan-activity; sid:{2}; rev:1;)".format(
                            httppacket.fields))
                    print(
                        "\nFilename:\nalert tcp $HOME_NET any -> any $HTTP_PORTS (msg: \"Suspicious HTTP file name \"{0[Path]}\" requested at {0[Host]}!\"; flow:established,to_server; content:\"{0[Path]}\"; http_uri; reference:arachnids; classtype:trojan-activity; sid:{2}; rev:1;)".format(
                            httppacket.fields))
            ...
            # Check if UDP is present in the packet
                ...
                save(
                    "alert udp {0} {1} -> any any (msg: \"Suspicious IP {0} and port {1} detected!\"; reference:arachnids; classtype:trojan-activity; sid:{2}; rev:1;)".format(
                        ipsource, udpsrcport,sid_gen()))
                save(
                    "alert udp any any -> {0} {1} (msg: \"Suspicious IP {0} and port {1} detected!\"; reference:arachnids; classtype:trojan-activity; sid:{2}; rev:1;)".format(
                        ipdest, udpdestport,sid_gen()))
                # Check if DNS is present in the packet
                if DNS in singlepacket:
                    print("{0}----- DNS -----\n{1}".format(G, W))
                    hostname = singlepacket[DNSQR].qname
                    if DNSRR in singlepacket:
                        ...
                        for addr in addrsplit:
                            hexaddr = format(int(addr), '02x')
                            print("\b", hexaddr.upper(), )
                        print("\b|\"; distance:4; reference:arachnids; classtype:trojan-activity; sid:{2}; rev:1;)")
                    else:
                        save(
                            "alert udp $HOME_NET any -> any 53 (msg: \"Suspicious DNS request for {0} detected!\"; content:\"|01 00 00 01 00 00 00 00 00 00|\"; depth:10; offset:2; content:\"".format(
                                hostname)),
                        ...
                        for word in dnsplit:
                            if word != '':
                                ...
                                print("\b|{0}|{1}".format(upper, word)),
                        print(
                            "\b|00|\"; fast_pattern; nocase; distance:0; reference:arachnids; classtype:trojan-activity; sid:{2}; rev:1;)")
            ...
            # Check if ICMP is present in the packet
                ...
                save(
                    "alert icmp {0} any -> {1} any (msg: \"Suspicious ICMP packet from {0} to {1} with type {2}!\"; icode:0; itype:{2}; reference:arachnids; classtype:trojan-activity; sid:{3}; rev:1;)".format(
                        ipsource, ipdest, icmptype, sid_gen()))
